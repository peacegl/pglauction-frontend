...
import PermissionUsers from './permission_users';

export default function PermissionUsersModal({open, toggleOpen, id, width}) {
    ...
    <>
      <Modal open={open} sx={{display: 'flex', alignItems: 'center'}}>
        ...
        >
          ...
          >
            <PermissionUsers id={id}></PermissionUsers>
          </CardContent>
        </Card>
      </Modal>
    </>
...
PermissionUsersModal.propTypes = {
