...
export const GET_PERMISSION_ROLES_LIST = 'GET_PERMISSION_ROLES_LIST';

// permission_list

export const GET_PERMISSION_LIST = 'GET_PERMISSION_LIST';
export const GET_ALL_PERMISSION_LIST = 'GET_ALL_PERMISSION_LIST';
export const GET_PERMISSION_USERS_LIST = 'GET_PERMISSION_USERS_LIST';
export const GET_ROLES_PERMISSION_LIST = 'GET_ROLES_PERMISSION_LIST';
...
export const GET_AUCTION_ITEM_BID = 'GET_AUCTION_ITEM_BID';
export const GET_AUCTION_ITEM_BID_EMPTY = 'GET_AUCTION_ITEM_BID_EMPTY';
export const GET_AUCTION_ITEM_BID_IS_ACCEPTED =
  'GET_AUCTION_ITEM_BID_IS_ACCEPTED';
export const ADD_NEW_BID = 'ADD_NEW_BID';
export const INCREMENT_TOTAL_BID = 'INCREMENT_TOTAL_BID';
export const GET_VEHICLE_AUCTIONS_CHANGES = 'GET_VEHICLE_AUCTIONS_CHANGES';
export const GET_AUCTION_ITEMS_CHANGE = 'GET_AUCTION_ITEMS_CHANGE';
...
export const EXPIRE_AUCTION = 'EXPIRE_AUCTION';
